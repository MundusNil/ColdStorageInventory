...
export function PartDetailsPanel({
  ...
  const tl: DetailsField[] = [
    ...
    { type: 'string', name: 'description', label: t`说明`, copy: true },
    {
      type: 'link',
      name: 'variant_of',
      label: t`Variant of`,
  ...
  const bl: DetailsField[] = [
    { type: 'boolean', name: 'active', label: t`启用` },
    { type: 'boolean', name: 'locked', label: t`锁定` },
    {
      type: 'boolean',
      icon: 'template',
      name: 'is_template',
    ...
    { type: 'boolean', name: 'assembly', label: t`组合货品` },
    { type: 'boolean', name: 'component', label: t`可作为配货组成` },
    {
      type: 'boolean',
      name: 'testable',
      label: t`需要质检`,
    ...
    { type: 'boolean', name: 'trackable', label: t`可追踪批次` },
    { type: 'boolean', name: 'purchaseable', label: t`可进货` },
    {
      type: 'boolean',
      name: 'salable',
      icon: 'saleable',
    ...
    { type: 'boolean', name: 'virtual', label: t`虚拟货品` },
    { type: 'boolean', name: 'starred', label: t`已订阅`, icon: 'bell' }
  ];
